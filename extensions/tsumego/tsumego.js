 ...
 */
  ...
  Tsumego.prototype.hint = function (e) {
    ...
    this.setInfo(WGo.t('tsumego-already-wrong'))
  }

  Tsumego.prototype.variationEnd = function (e) {
    if (!e.node.comment) {
      switch (e.node._ev) {
        case 0:	this.setInfo(WGo.t('tsumego-incorrect')); break
        case 1: this.setInfo(WGo.t('tsumego-doubtful')); break
        case 2: this.setInfo(WGo.t('tsumego-interesting')); break
        case 3: this.setInfo(WGo.t('tsumego-correct')); break
        default: this.setInfo(WGo.t('tsumego-unknown')); break
      }
    }
